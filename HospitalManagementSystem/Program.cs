...
namespace HospitalManagementSystem
{
    internal class Program
    {
        ...
        static void AddNewPatient()
        {
            ...
            hospital.AddPation(new Patient(PatID, PatName, PatAge, gender, Ailment, DocList[DocIndex - 1]));
            Console.Clear();
